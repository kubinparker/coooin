...
<!--      <p class="user__title"><img src="/user/common/images/theme/title_cms.png" alt="CATERS CMS" class="brand-image"></p>-->
      <img src="/user/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="color:#000;">CATERS CMS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
        <?php if ($Session->read('data.face_image')): ?>
          <img src="<?= $Session->read('data.face_image'); ?>" class="img-circle elevation-2" alt="User Image">
        <?php else: ?>
          <img src="/user/dist/img/avatar5.png" class="img-circle elevation-2" alt="User Image">
        <?php endif; ?>
        </div>
        <div class="info">
          <a href="#" class="d-block"><?= $Session->read('data.name'); ?></a>
        </div>
      </div>
