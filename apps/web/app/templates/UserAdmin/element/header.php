<!--
  <span class="ml-5" style="display: inline-block;">
      <h1 class="h2" style="line-height: 3.5rem"><a href="<?= $this->Url->build(['_name' => 'userTop']); ?>" class="text-white" style="text-decoration: none;">管理システム</a></h1>
  </span> -->
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?= $this->Url->build(['_name' => 'userTop']); ?>" class="nav-link">Home</a>
      </li>
      <!-- <li class="nav-item d-none d-sm-inline-block">
